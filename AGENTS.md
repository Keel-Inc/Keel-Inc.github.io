...
This is an Astro-based static site for Keel Inc. The site is deployed to GitHub Pages at https://keel-inc.com.
...
CI runs markdown linting on all pushes and PRs (`.github/workflows/lint.yml`). Deployment to GitHub Pages is handled by `.github/workflows/deploy.yml`.
